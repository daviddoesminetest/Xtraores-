if minetest.settings:get("xtraores_enable_guns") == "true" then
        ...
        on_use = function(itemstack, user, pointed_thing)
            ...
            if xo_wpn_c_down > 20 then
                ...
                if pos and dir and yaw then
                    pos.y = pos.y + 1.6
                    local obj =
                        minetest.add_entity(pos, "xtraores:platinumshot")
                    if obj then
                        ...
                        pos.y = pos.y - 0.2
                        local obj =
                            minetest.add_entity(pos, "xtraores:gunsmoke")
                        minetest.sound_play("xtraores_revolver", {object = obj})
                        obj:setvelocity({
                            x = dir.x * 3,
                            y = dir.y * 3,
        ...
        if self.timer > 0.10 then
            ...
            for k, obj in pairs(objs) do
                if obj:get_luaentity() ~= nil then
                    if obj:get_luaentity().name ~= "xtraores:platinumshot" and
    ...
    minetest.register_craft({
        ...
        recipe = {
            "xtraores:platinum_revolver_base", "xtraores:platinum_mag",
            "xtraores:revolver_handle"
        }
    })
    ...
    minetest.register_craft({
        ...
        recipe = {
            {'', 'default:gold_ingot', ''}, {'', 'xtraores:platinum_bar', ''},
    ...
    xtraores_cobaltshot.on_step = function(self, dtime)
        ...
        if self.timer > 0.07 then
            ...
            for k, obj in pairs(objs) do
                if obj:get_luaentity() ~= nil then
                    if obj:get_luaentity().name ~= "xtraores:cobaltshot" and
                        obj:get_luaentity().name ~= "__builtin:item" then
                        local damage = 12
                        obj:punch(shooter, 1.0, {
                            full_punch_interval = 1.0,
    ...
    minetest.register_craft({
        ...
        recipe = {
            "xtraores:cobalt_top", "xtraores:cobalt_base",
            "xtraores:cobalt_handle"
        }
    })
    ...
    xtraores_orichalcumshot.on_step = function(self, dtime)
        ...
        if self.timer > 0.05 then
            ...
            for k, obj in pairs(objs) do
                if obj:get_luaentity() ~= nil then
                    if obj:get_luaentity().name ~= "xtraores:orichalcumshot" and
                        obj:get_luaentity().name ~= "__builtin:item" then
                        local damage = 26
                        obj:punch(shooter, 1.0, {
                            full_punch_interval = 1.0,
    ...
    minetest.register_craft({
        ...
        recipe = {
            "xtraores:orichalcum_rifle_barrel",
            "xtraores:orichalcum_rifle_scope", "xtraores:orichalcum_rifle_base",
            "xtraores:orichalcum_rifle_stock", "xtraores:orichalcum_rifle_grip",
    ...
    xtraores_gunsmoke.on_step = function(self, dtime)
        ...
        if self.timer > 1 then
            ...
            for k, obj in pairs(objs) do
                if obj:get_luaentity() ~= nil then
                    if obj:get_luaentity().name ~= "xtraores:gunsmoke" and
                        obj:get_luaentity().name ~= "__builtin:item" then
    ...
    minetest.register_tool("xtraores:sword_radioactive", {
        description = "" .. core.colorize("#68fff6", "Radioactive sword\n") ..
            ...
            core.colorize("#FFFFFF", "range: 5.9\n") .. core.colorize("#FFFFFF",
                                                                      "Launches radioactive projectiles that deal 15 damage while swung\n") ..
    ...
    xtraores_radioactive_ray.on_step = function(self, dtime)
        ...
        if self.timer > 0.1 then
            ...
            for k, obj in pairs(objs) do
                if obj:get_luaentity() ~= nil then
                    if obj:get_luaentity().name ~= "xtraores:radioactive_ray" and
                        obj:get_luaentity().name ~= "__builtin:item" then
                        local damage = 15
                        obj:punch(shooter, 1.0, {
                            full_punch_interval = 1.0,
    ...
    minetest.register_entity("xtraores:radioactive_ray",
                             xtraores_radioactive_ray)
    ...
    xtraores_titaniumshot_handgun.on_step =
        function(self, dtime)
            self.timer = self.timer + dtime
            local pos = self.object:getpos()
            local node = minetest.get_node(pos)
                ...
                for k, obj in pairs(objs) do
                    if obj:get_luaentity() ~= nil then
                        if obj:get_luaentity().name ~=
                            "xtraores:titaniumshot_handgun" and
                            obj:get_luaentity().name ~= "__builtin:item" then
                            local damage = 28
                            obj:punch(shooter, 1.0, {
                                full_punch_interval = 1.0,
    ...
    minetest.register_entity("xtraores:titaniumshot_handgun",
                             xtraores_titaniumshot_handgun)
    ...
    xtraores_titaniumshot_machinegun.on_step =
        function(self, dtime)
            self.timer = self.timer + dtime
            local pos = self.object:getpos()
            local node = minetest.get_node(pos)
            ...
            if self.timer > 0.1 then
                ...
                for k, obj in pairs(objs) do
                    if obj:get_luaentity() ~= nil then
                        if obj:get_luaentity().name ~=
                            "xtraores:titaniumshot_machinegun" and
                            obj:get_luaentity().name ~= "__builtin:item" then
                            local damage = 22
                            obj:punch(shooter, 1.0, {
                                full_punch_interval = 1.0,
    ...
    minetest.register_entity("xtraores:titaniumshot_machinegun",
                             xtraores_titaniumshot_machinegun)
    ...
    minetest.register_craft({
        ...
        recipe = {
            "xtraores:titanium_gun_barrel", "xtraores:titanium_handgun_base",
            "xtraores:titanium_gun_handle"
        }
    })
    ...
    minetest.register_craft({
        ...
        recipe = {
            "xtraores:titanium_gun_barrel", "xtraores:titanium_machinegun_base",
            "xtraores:titanium_machinegun_stock",
            "xtraores:titanium_gun_barrel", "xtraores:titanium_machinegun_mag",
            "xtraores:titanium_gun_handle"
        }
    })
    ...
    minetest.register_craft({
        ...
        recipe = {
            {'', 'default:diamond', ''}, {'', 'xtraores:titanium_bar', ''},
